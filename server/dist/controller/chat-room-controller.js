...
export const getChatRoomMessageHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (skip == 0) {
            const messageSizeData = yield ChatRoomModel.aggregate([
                { $match: { _id: chatRoomObjectId } },
        ...
        return res.status(200).json(Object.assign(Object.assign({}, chatRoomMessages), { totalMessages }));
    }
    catch (error) {
        console.log(error);
...
export const getChatRoomMessageReactionHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const chatRoomMessageReactions = yield ChatRoomModel.aggregate([
            { $match: { _id: chatRoomObjectId } },
