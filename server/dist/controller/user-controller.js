...
export const modifyUserProfileHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { _id } = req.user;
        const userObjectId = new mongoose.Types.ObjectId(_id);
        ...
        if (cloudinaryUpload.imageUrl) {
            yield UserModel.findOneAndUpdate({ _id: userObjectId }, { profileImageUrl: cloudinaryUpload.imageUrl });
