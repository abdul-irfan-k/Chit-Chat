...
import { ACESSTOKENNOTPROIVIDED, FILENOTINCLUEDED, INVALIDCOMFIRMPASSWORD, INVALIDOTP, INVALIDPASSWORD, OTPRECORDNOTFOUND, USERALREADEXIST, USERNOTFOUND, USERNOTGLOGEDIN, } from "../constants/constants.js";
...
export const updateUserProfileHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { _id } = req.user;
        const userObjectId = new mongoose.Types.ObjectId(_id);
        ...
        if (cloudinaryUpload.url) {
            yield UserModel.findOneAndUpdate({ _id: userObjectId }, { profileImageUrl: cloudinaryUpload.url });
...
export const updateUserDetailHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { _id } = req.user;
        const userObjectId = new mongoose.Types.ObjectId(_id);
        ...
        if (profileImageUrl != undefined) {
            yield UserModel.findOneAndUpdate({ _id: userObjectId }, Object.assign({ profileImageUrl: profileImageUrl }, userUpdatedDetails));
        }
        else {
            yield UserModel.findOneAndUpdate({ _id: userObjectId }, Object.assign({ profileImageUrl: profileImageUrl }, userUpdatedDetails));
        }
...
export const updateSettingHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { _id } = req.user;
        const userObjectId = new mongoose.Types.ObjectId(_id);
        const { setting } = req.body;
        yield UserSettingModel.findOneAndUpdate({ _id: userObjectId }, Object.assign({}, setting));
...
export const gettingStartedSettingSetupHandler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { _id } = req.user;
        const userObjectId = new mongoose.Types.ObjectId(_id);
        ...
        if (userSetting == null) {
            ...
            yield newUserSettting.save();
            return res.status(200).json({ isUpdated: true });
        }
        yield UserSettingModel.findOneAndUpdate({ _id: userObjectId }, { $set: { "generalSetting.theme": theme } });
        return res.status(200).json({ isUpdated: true });
    }
    catch (error) {
        return res.status(400).json({});
