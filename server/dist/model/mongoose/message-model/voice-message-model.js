...
voiceMessageSchema.statics.createNewMessageInChatRoom = function ({ chatRoomId, postedByUser, voiceMessageSrc, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const post = yield this.create({ postedByUser, voiceMessageSrc });
        return post;
    });
};
const voiceMessageModel = model("voiceMessage", voiceMessageSchema);
